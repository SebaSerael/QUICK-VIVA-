...
$sql = "select * from Student where batchcode=(select batch from subject where subid=(select subjectid from examdates where examid='$eid'))";
        ...
        <div class="box">
          <div class="detail-box">
           ...
           Student Approval
			...
			<form id="frm" method="post" action="createadm.php">
...
?> 
		    ...
		    <tr>
		    <th><?php echo $stid; ?></th>			
		   <th><?php echo $stname; ?></th>		   
		   <th><?php echo $batcod; ?></th>
		   <th><?php echo $gen; ?></th>
		   <th><?php echo $corcod; ?></th>
		   <th><?php echo $DOB; ?></th>
		   <th><?php echo $age; ?></th>
