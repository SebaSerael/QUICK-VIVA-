        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
             <ul class="navbar-nav  ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="admit.php"> Create Admit Card</a>
              </li>
			   <li class="nav-item">
        ...
        <div class="box">
          <div class="detail-box">
           ...
           NewSUbject Addition
			...
			<form id="frm" method="post" action="subaddnext.php">
           <table width=500 border=4>
		   <p align="left">
		   <tr>
		    <th>Subject Id </th>
			<th><input type=text readonly value="SB<?php echo $cnt; ?>" name=subid></th>
		   
		   </tr>
		   <th>Subject Name</th>
		   <th><input type=text name=subnam required></th>
		   </tr>
		 </tr>
		   <th>Batch</th>
		   <th>
		   ...
		   <?php
			...
			while($row=mysqli_fetch_array($rs))
			{
				...
				$corid=$row[1];
				?>
				<option value=<?php echo $bid; ?>><?php echo $corid; ?></option>
		    ...
		    <tr>
		   <th>Syllubus</th>
		   <th><textarea name=syllb col=50 rows=3></textarea> </th>
		   </tr>
		<tr>
		   <th>Subject Type</th>
		   <th><select  name=subtyp required><option>Lab</option><option>Theory</option></select></th>
		   </tr>
		   <tr>
