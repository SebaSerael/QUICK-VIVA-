...
$sql="update logtab set usertype='false' where logid='EXT00'";
        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="allowext.php"> Allow External</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="disableext.php">Disable External</a>
              </li>
			  <li class="nav-item">
                <a class="nav-link" href="closeexam.php">Close Exam Process</a>
              </li>
              <li class="nav-item">
  ...
  <section class="why_section layout_padding">
    <div class="container">
      <div class="heading_container heading_center">
        <h2>
         External<span>Log is</span> disabled now
        </h2>
      </div>
