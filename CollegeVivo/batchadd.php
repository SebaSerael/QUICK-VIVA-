        ...
        <div class="box">
          <div class="detail-box">
           ...
           New Batch Addition
			...
			<form id="frm" method="post" action="batchaddnext.php">
           <table width=500 border=4>
		   <p align="left">
		   <tr>
		    <th>Batch Id </th>
			<th><input type=text readonly value="BT<?php echo $cnt; ?>" name=bid></th>
		   </tr>
		   <tr>
		   <th>Select Course</th>
		   <th>
		   ...
		   <?php
		    ...
		    <tr>
		   <th>Running Sem</th>
		   <th><input type=text name=sem></th>
		   </tr>
