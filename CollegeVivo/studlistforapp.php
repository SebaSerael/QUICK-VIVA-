...
$sql = "select * from Student where status='NewReg'";
        ...
        <div class="box">
          <div class="detail-box">
           ...
           Student Approval
			...
			<form id="frm" method="post" action="PSregnext.php">
...
?> 
		   ...
		   <th><?php echo $phno; ?></th>
		   <th><a href="appstud.php?stid=<?php echo $stid; ?>&pwd=<?php echo $email;?>">Approve</a></th>
		   </tr>
