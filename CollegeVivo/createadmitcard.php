      ...
      <div class="why_container">
        <div class="box">
          <div class="detail-box">
			...
			<form id="frm" method="post" action="studlist.php">
           <table width=500 border=4>
		   <tr>
		    <th>Exam Id</th>
			<th><select name=eid>
			<?php
            $sql = "select * from examdates where DATE_FORMAT(examdt,'%y-%m-%d') like DATE_FORMAT( CURRENT_DATE,'%y-%m-%d')";
