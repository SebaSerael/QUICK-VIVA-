      ...
      <div class="why_container">
        <div class="box">
          <div class="detail-box">
			...
			<form id="frm" method="post" action="regstudentnext.php">
           <table width=500 border=4>
		   <p align="left">
		   <tr>
		    <th>Student Reg Id </th>
			<th><input type=text readonly value="ST<?php echo $cnt; ?>" name=stid></th>
		   </tr>
		  
			<tr>
		   <th>STudent Name</th>
		   <th><input type=text name=stname required></th>
		   </tr>
		   <tr>
		    <th>BatchCode</th>
		   <th>
		   ...
		   <?php
		    ...
		    <tr>
		   <th>Gender</th>
		   <th><input type=Radio name=gend value="Male">Male <input type=Radio name=gend value="FeMale">FeMale </th>
		   </tr>
		   <tr>
		   <th>CourseCode</th>
		   <th><input type=text name=corcode required></th>
		   </tr>
		    </tr>
		   <th>Date Of Birth</th>
