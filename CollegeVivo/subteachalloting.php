      ...
      <div class="why_container">
        <div class="box">
          <div class="detail-box">
            <h5>
           Allot teacher Subject Addition
            </h5>
			<form id="frm" method="post" action="subteachallotnext.php">
		   ...
		   <tr>
			...
			<th><select name=tid>
			 <?php
            $sql = "select * from teacher where status='Approved'";
		   ...
		   <?php
            $sql = "select * from subject where batch='$bid' and stype='Lab'";
		    ...
		    <tr>
		   <th>CourseId</th>
		   <th><input type=text readonly value="<?php echo $cid; ?>" name=cid></th>
		   </tr>
		    <tr>
		   <th>BatchID</th>
		   <th><input type=text readonly value="<?php echo $bid; ?>" name=bid> </th>
		   </tr>
