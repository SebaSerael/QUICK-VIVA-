        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="courseadd.php"> Add Course</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="batchadd.php">Add Batch</a>
              </li>
              <li class="nav-item">
        ...
        <div class="box">
          <div class="detail-box">
           ...
           New Course Addition
			...
			<form id="frm" method="post" action="courseaddnext.php">
           <table width=500 border=4>
		   <p align="left">
		   <tr>
		    <th>Course Id </th>
			<th><input type=text readonly value="CR<?php echo $cnt; ?>" name=cid></th>
		   
		   </tr>
		   <th>Course Name</th>
		   <th><input type=text name=cornam></th>
		   </tr>
		    <tr>
		   <th>Year Of Adm</th>
		   <th><input type=text name=yra></th>
		   </tr>
