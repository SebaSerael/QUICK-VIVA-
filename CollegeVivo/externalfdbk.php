...
$sql="select resid,examid,(select studentname from student where sutudentidid=studid)stdid,Nqn,crtAns,totalmark from result where status='Declared'";
      ...
      <div class="container-fluid">
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ">
              <li class="nav-item">
                <a class="nav-link" href="chkexam.php">Check Exam Date</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="attendvivo.php"> Attend Viva</a>
              </li>
			   <li class="nav-item">
                <a class="nav-link" href="chkres.php">Check Result</a>
              </li>
      ...
      <div class="why_container">
        <div class="box">
          <div class="detail-box">
		   ...
		   <tr>
		    <th>Res Id</th><th>Exam Id</th><th>Student Name</th><th>Qnatnd</th><th>CorrctAns</th><th>totmark</th><th>feedback</th>
		   </tr>
		   <?php
		   ...
		   ?>
		   <tr>	   
			<th><?php echo $resid; ?></th><th><?php echo $examid; ?></th><th><?php echo $sname; ?></th>	<th><?php echo $qnat; ?></th>	<th><?php echo $crtan; ?></th><th><?php echo $tm; ?></th><th><?php echo $fdbk; ?></th>		
		   </tr>
			<?php
		   }
		   $conn->close();
