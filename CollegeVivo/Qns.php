        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
             <ul class="navbar-nav  ">
              ...
              <li class="nav-item">
                <a class="nav-link" href="shuffled.php">Shuffle & Choose Qns</a>
              </li>
              <li class="nav-item">
        ...
        <div class="box">
          <div class="detail-box">
           ...
           New Questions Addition
			...
			<form id="frm" method="post" action="Qnsaddnext.php">
           <table width=500 border=4>
		   <p align="left">
		   <tr>
		    <th>Question Id </th>
			<th><input type=text readonly value="QN<?php echo $cnt; ?>" name=qid></th>
		   ...
		   <?php
		    ...
		    <tr>
		   <th>Question</th>
		   <th><textarea name=qn col=40 rows=3 required></textarea> </th>
		   </tr>
		    <tr>
		   <th>opt1</th>
		   <th><textarea name=opt1 col=40 rows=3 required></textarea> </th>
		   </tr> <tr>
		   <th>Opt2</th>
		   <th><textarea name=opt2 col=40 rows=3 required></textarea> </th>
		   </tr>
		    <tr>
		   <th>Opt3</th>
		   <th><textarea name=opt3 col=40 rows=3 required></textarea> </th>
		   </tr>
		    <tr>
		   <th>Opt4</th>
		   <th><textarea name=opt4 col=40 rows=3 required></textarea> </th>
		   </tr>
		<tr>
		   <th>Answer</th>
		   <th><select  name=ans required><option>Opt1</option><option>Opt2</option><option>Opt3</option><option>Opt4</option></select></th>
		   </tr>
		   <tr>
